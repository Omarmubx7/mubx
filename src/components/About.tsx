      ...
      <div className="max-w-[1200px] mx-auto w-full relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-0 md:divide-x md:divide-white/[0.06] mb-16 md:mb-24">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center px-4">
                <div className="text-4xl md:text-5xl font-black text-[#FF2E2E] font-mono tracking-tight mb-2">
                  {stat.value}
                </div>
        ...
        <SectionWrapper delay={0.1}>
          <div className="mb-12 md:mb-16">
            <div className="text-[10px] font-mono text-[#FF2E2E] uppercase tracking-[0.2em] mb-4">
              // ABOUT ME
            </div>
            <h2 className="text-3xl md:text-5xl font-mono font-light tracking-tight text-[#EDE8E4] mb-4">
              The person behind
              <br />
              <span className="text-[#FF2E2E]">the terminal.</span>
            </h2>
          </div>
        </SectionWrapper>
        ...
        <SectionWrapper delay={0.4}>
          <div>
            <div className="text-[10px] font-mono text-[#FF2E2E] uppercase tracking-[0.2em] mb-8">
              // JOURNEY
            </div>
              ...
              <div className="grid grid-cols-4 gap-4">
                {milestones.map((m, i) => (
                  <div key={m.year} className="relative flex flex-col items-center text-center">
                    {/* Dot */}
                    <div className="w-[15px] h-[15px] rounded-full bg-[#FF2E2E] border-2 border-[#0D0D0D] relative z-10 mb-4" />

                    {/* Year */}
                    <div className="text-sm font-mono font-bold text-[#FF2E2E] mb-1">
                      {m.year}
                    </div>
