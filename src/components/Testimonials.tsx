...
export default function Testimonials() {
    ...
    const socialLinks = [
        ...
        'https://www.instagram.com/aqabwi',
        'https://menonlyshow-gray.vercel.app/'
    ];
    ...
    return (
        <section id="testimonials" className="py-24 relative overflow-hidden bg-background min-h-[600px]">
            {!isMounted ? null : (
                <>
