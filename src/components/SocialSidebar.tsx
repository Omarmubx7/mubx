...
const socials = [
  ...
  },
  {
    ...
    // LinkedIn's official brand blue
    defaultColor: '#6B625E',
    hoverColor: '#0A66C2',
...
export default function SocialSidebar() {
  ...
  return (
    <motion.div
      ...
      className="fixed left-0 top-1/2 -translate-y-1/2 z-50 hidden lg:flex flex-col items-center gap-1 py-6 px-[10px]"
    >
      {/* Top line */}
      <div
        className="w-px mb-4"
      ...
      {socials.map((social) => {
        const isHovered = hovered === social.label
        return (
          <div key={social.label} className="relative group" style={{ position: 'relative' }}>
            <a
              href={social.href}
              target="_blank"
            ...
            <span
              style={{
                ...
                border: `1px solid ${isHovered ? social.hoverColor + '40' : 'rgba(255,255,255,0.08)'}`,
                color: isHovered ? social.hoverColor : '#9E9490',
                fontSize: 10,
