                    ...
                    <div className="p-10 rounded-3xl bg-neon/10 border border-neon/20 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <a
                                ...
                                className="px-8 py-4 bg-neon text-white font-bold text-lg rounded-full hover:bg-white transition-all transform hover:scale-105 shadow-[0_0_20px_rgba(255,46,46,0.3)] flex items-center justify-center gap-2"
                            >
