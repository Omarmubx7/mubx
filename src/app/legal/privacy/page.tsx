        ...
        <div className="container mx-auto px-6 py-32 text-white max-w-4xl">
            ...
            <div className="prose prose-invert prose-lg max-w-none">
                ...
                <section className="mb-10">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-muted/80">
                ...
                <section className="mb-10">
                    <h2 className="text-2xl font-bold text-white mb-4">4. Cookies & Analytics</h2>
                    <p className="text-muted/80 leading-relaxed">
                ...
                <section className="mb-10">
                    ...
                    <p className="text-muted/80 leading-relaxed">
                        ...
                        <br />
                        <span className="text-white font-mono">Location: Amman, Jordan</span>
                    </p>
                </section>
            </div>
        </div>
